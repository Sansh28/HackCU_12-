...
- `WORKFLOW.md` for the short, visual summary
- `ARCHITECTURE.md` for the structural overview
...
5. Open `savant-backend/main.py`
6. Open the backend router and service files
7. Open `savant-frontend/src/app/page.tsx`
8. Open `savant-frontend/src/components/SavantTerminal.tsx`
9. Open `savant-frontend/src/components/PaperGraphExplorer.tsx`
10. Open `savant-extension/src/background.ts`
