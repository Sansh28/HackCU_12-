...
Create app-specific env files under `apps/backend`, `apps/frontend`, and `apps/extension` using each `.env.example`.
...
uvicorn savant_backend.main:app --app-dir src --host 127.0.0.1 --port 8000
```
